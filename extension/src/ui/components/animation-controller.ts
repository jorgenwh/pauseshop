...
export class AnimationController {
    ...
    public slideInFromRight(config: AnimationConfig): Promise<void> {
        return new Promise((resolve, reject) => {
            try {
                ...
                this.slideInAnimation = this.element.animate(
                    keyframes,
                    animationOptions,
                );
    ...
    public slideOutToRight(config: AnimationConfig): Promise<void> {
        return new Promise((resolve, reject) => {
            try {
                ...
                const slideOutAnimation = this.element.animate(
                    keyframes,
                    animationOptions,
                );
    ...
    public slideDown(config: AnimationConfig): Promise<void> {
        return new Promise((resolve, reject) => {
            try {
                ...
                const slideDownAnimation = this.element.animate(
                    keyframes,
                    animationOptions,
                );
    ...
    public slideUp(config: AnimationConfig): Promise<void> {
        return new Promise((resolve, reject) => {
            try {
                ...
                const slideUpAnimation = this.element.animate(
                    keyframes,
                    animationOptions,
                );
        ...
        return new Promise((resolve, reject) => {
            try {
                const keyframes = [
                    ...
                    {
                        transform: `translateX(-${config.distance}px) scale(1)`,
                        opacity: "1",
                    },
                ];
                ...
                const slideLeftAnimation = this.element.animate(
                    keyframes,
                    animationOptions,
                );
    ...
    public slideRight(
        ...
        return new Promise((resolve, reject) => {
            try {
                ...
                const slideRightAnimation = this.element.animate(
                    keyframes,
                    animationOptions,
                );
    ...
    public crossFade(
        ...
        return new Promise((resolve, reject) => {
            try {
                const fadeOutPromise = this.fadeElement(
                    fromElement,
                    1,
                    0,
                    config.duration / 2,
                ...
                Promise.all([fadeOutPromise, fadeInPromise])
                    .then(() => resolve())
                    .catch(reject);
            } catch (error) {
                reject(error);
    ...
    public transformContent(
        config: AnimationConfig & { fromOpacity: number; toOpacity: number },
    ): Promise<void> {
        return new Promise((resolve, reject) => {
            try {
                const keyframes = [
                ...
                const transformAnimation = this.element.animate(
                    keyframes,
                    animationOptions,
                );
