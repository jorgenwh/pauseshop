...
export class SidebarHeader {
    ...
    public create(): HTMLElement {
        ...
        this.element.className =
            "flex justify-between items-center mb-5 pb-4 border-b border-slate-600/80";
    ...
    private createCloseButton(): HTMLElement {
        ...
        closeButton.className =
            "w-14 h-14 flex items-center justify-center bg-transparent hover:bg-white/10 rounded-full transition-colors duration-200 mr-[20px]";
