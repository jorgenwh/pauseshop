...
export class SidebarHeader {
    ...
    public create(): HTMLElement {
        ...
        logoIcon.innerHTML = `
            <svg class="w-7 h-7 text-indigo-400" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        ...
        titleText.className = 'text-xl font-bold text-slate-100';
