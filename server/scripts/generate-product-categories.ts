...
const OUTPUT_FILE = resolve(__dirname, '../src/config/product-categories.ts');
...
`;
        ...
        console.log(`[BUILD] Successfully generated ${OUTPUT_FILE} with ${categories.length} categories.`);
    } catch (error) {
