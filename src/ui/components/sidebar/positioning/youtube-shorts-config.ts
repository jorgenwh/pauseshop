...
export const YOUTUBE_SHORTS_POSITIONING = {
    ...
    left: {
        compact: -120,      // Compact sidebar when in left mode
        expanded: -300,    // Expanded sidebar when in left mode
        loading: -120,      // Loading state when in left mode
    },
    right: {
        compact: 120,       // Compact sidebar when in right mode
        expanded: 300,     // Expanded sidebar when in right mode
        loading: 120,       // Loading state when in right mode
    },
