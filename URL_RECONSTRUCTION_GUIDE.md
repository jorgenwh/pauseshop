...
This document explains how to decode and reconstruct the optimized referrer URLs generated by the FreezeFrame extension.
...
Example:
```
https://freeze-frame.net/referrer?pauseId=session-123&data=T-Shirt~clothing~0~SomeBrand~FF0000~00FF00,0000FF~FeatureA,FeatureB~2~t-shirt,shirt~0.95||1|710PSL6OBTLB0CB3VXLPZ3799|61abc123DEFB07XJ8C8F54550
```
